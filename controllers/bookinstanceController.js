...
exports.bookinstance_update_post = [
    ...
    (req, res, next) => {
        ...
        var bookinstance = new BookInstance(
            {
                ...
                status: req.body.status,
                due_back: req.body.due_back,
                _id: req.params.id  // this is necessary, otherwise it will create a new ID
        ...
        if (!errors.isEmpty()) {
            ...
            //Data from form is valid
            BookInstance.findByIdAndUpdate(bookinstance._id, bookinstance, {})
                .exec(function(err, thebookinstance) {
                    if (err) { return next(err); }

                    //Success, so redirect to bookinstance detail page
